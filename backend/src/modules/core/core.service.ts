...
export async function createMember(input: any, userId?: string) {
...
function estimateAmount(planName: string) {
  const lower = planName.toLowerCase();
  if (lower.includes('quarterly')) return 3200;
  if (lower.includes('annual') || lower.includes('warrior')) return 10000;
  if (lower.includes('couple')) return 5500;
  if (lower.includes('elite')) return 6000;
  return 1200;
}

export async function updateMember(id: string, updates: any, userId?: string) {
...
export async function renewMember(id: string, planName: string, durationMonths: number, cost: number, userId?: string) {
...
export async function createTrainer(input: any, userId?: string) {
...
export async function updateTrainer(id: string, updates: any, userId?: string) {
...
export async function createReceptionist(input: any, userId?: string) {
...
export async function updateReceptionist(id: string, updates: any, userId?: string) {
...
export async function assignTrainer(memberId: string, trainerId: string, userId?: string) {
...
export async function removeTrainer(memberId: string, userId?: string) {
...
export async function checkIn(memberId: string, userId?: string) {
...
export async function createPayment(input: any, userId?: string) {
...
export async function createNotice(input: any, userId?: string) {
...
export async function upsertWorkout(input: any, userId?: string) {
  const existing = await prisma.workoutPlan.findFirst({ where: { memberId: input.memberId } });
  if (existing) await prisma.workoutPlan.delete({ where: { id: existing.id } });
...
export async function upsertDiet(input: any, userId?: string) {
  const existing = await prisma.dietPlan.findFirst({ where: { memberId: input.memberId } });
  if (existing) await prisma.dietPlan.delete({ where: { id: existing.id } });
...
export async function createProgress(input: any, userId?: string) {
